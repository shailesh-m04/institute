...
const CoursesMegaMenu = ({ mobile = false, closeMenu }) => {
  const containerStyles = mobile
    ? "w-full"
    : "absolute left-1/2 -translate-x-1/2 top-full w-screen max-w-[45vw] bg-white shadow-2xl border-t border-gray-100 z-[999]";

  return (
    <div className={containerStyles}>
      <div className={mobile ? "px-4 py-4" : "max-w-6xl mx-auto px-10 py-10"}>
        <div
